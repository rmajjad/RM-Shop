...
export default function Cart() {
    ...
    const { getCartContext, removeItemContext , removeAllItemsContext ,increaseQuantityContext,decreaseQuantityContext} = useContext(CartContext);
    ...
    const clearIAllItems = async () => {
        const res = await removeAllItemsContext();
        return res;
    }
                ...
                <div className="row">
                    <div className="cart-items">
                        <div className="products" id="products">
                            ...
                            <div className='createANDclear'>
                                <button className='btn bg-success text-white clearBtn rounded-pill' onClick={clearIAllItems} >Clear All</button>
                                <Link to={'/order'} className='btn bg-success text-white clearBtn rounded-pill'>Create Order</Link> 
                            </div>
                        </div>
